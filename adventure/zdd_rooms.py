    ...
    def run_story(self, user_items):
        ...
        while True:
            ...
            if input_choice == "turn around":
                ...
                print(
                    "You leave the room; it probably was the best choice to do..right?\n"
                )
                break
                ...
                while True:
                    ...
                    if headset_choice == "forget it":
                        ...
                        puzzle_word = "".join(
                            [chr(position + 64) for position in puzzle_sequence]
                        )
                        ...
                        while True:
                            ...
                            if answer_choice.lower() == "b":
                                print(
                                    "'NOOOOO HOW DID YOU SOLVE MY PUUZZLEEE-' you hear the creepy voice saying. The headset unlocks, and you can take it off."
                                )
                                # Last choice for the user_item input
                                while True:
                                    last_choice = input(
                                            "With this headset in your inventory, you can check various information such as the presence of other people in the building or other relevant details that could help you.\n"
                                    ...
                                    if last_choice == "yes":
                                            ...
                                            print(
                                            "It's too risky; what if the headset is cursed and brings you bad luck? You're probably better off without it.."
                                            )
                                            break
                                        ...
                                        break  # Break out of the last choice loop
                ...
                print("Invalid input. Try again.")
                break # exiting the firt while loop
