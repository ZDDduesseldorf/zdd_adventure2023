...
class TechnoClub(Room):
    ...
    def bar_story(self, drink = False, card = True):
        ...
        if action == "yes":
            ...
            if action == "yes":
                ...
                self.explore_club()
                """
    def bar_story2(self,drink=True, card=True):
        action = input("BARKEEPER:'Ouh do you want another drink?\n\n (yes/no):'").lower()
        if action == "yes":
            if card == False:
                print("BARTENDER: 'Still no stamp card huh?'")
    ...
    def explore_club(self):
        ...
        if action == "yes":
            ...
            if action == "yes":
                ...
                #action = input("OK, would you like to do anything else?\n (no/get a drink):\n\n").lower()
                return
            
                #if action == "leave":
                 #   return
                #elif action == "get a drink":
                 #   self.bar_story2()
        elif action == "no":
    ...
    def searchformusic(self):
        ...
        if action == "barkeeper":
            ...
            #action = input("Do you want to go back in and get a drink or leave the Club?\n (leave/get back in):").lower()
        
            #if action == "leave":
             #   print("YOU:'But I got to go now, see you!\n\n")
              #  return
            #elif action == "get back in":
